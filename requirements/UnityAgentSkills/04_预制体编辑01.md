...
- **示例场景**: 如果预制体中有两个名为 "UIButton_Confirm" 的按钮, 想修改第二个, 则设置 `siblingIndex: 1`
  ...
  "results": [
    {
      ...
      "result": {
        ...
        "modifiedProperties": [
          {
            "name": "name",
            "oldValue": "UIButton_Confirm",
            "newValue": "UIButton_Confirm_New"
          }
        ],
        "currentProperties": {
          "name": "UIButton_Confirm_New",
...
- 预期:
  - GameObject 的名称从 "UIButton_Confirm" 改为 "UIButton_Confirm_New"
...
- 假设当前 GameObject 的名称就是 "UIButton_Confirm"
- 预期:
