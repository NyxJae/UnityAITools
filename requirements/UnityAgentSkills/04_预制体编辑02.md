...
- 前置能力(依赖): 本功能依赖预制体查看能力,需先具备 `prefab.queryHierarchy` 和 `prefab.queryComponents`
- 前置能力(依赖): 本功能依赖预制体属性修改能力,需先具备 `prefab.setGameObjectProperties`
  ...
  "results": [
    {
      ...
      "result": {
        "prefabPath": "Assets/ResourcesAB/UIPrefabs/DialogMain.prefab",
        "deletedObjectPath": "DialogMain/Panel_Content/UIButton_Confirm",
...
- 假设 `Panel_Content` 包含 3 个子物体: `UIButton_Confirm`, `UIButton_Cancel`, `UILabel_Title`
- 预期:
...
- 假设 `Panel_Content` 下有两个 `UIButton_Confirm` (siblingIndex 分别为 0 和 1)
- 预期:
- 删除第二个 `UIButton_Confirm` (siblingIndex=1)
- 第一个 `UIButton_Confirm` 保持不变
  ...
  "commands": [
    {
      ...
      "params": {
        "prefabPath": "Assets/ResourcesAB/UIPrefabs/DialogMain.prefab",
        "sourcePath": "DialogMain/Panel_Content/UIButton_Confirm",
  ...
  "results": [
    {
      ...
      "result": {
        "prefabPath": "Assets/ResourcesAB/UIPrefabs/DialogMain.prefab",
        "sourcePath": "DialogMain/Panel_Content/UIButton_Confirm",
        "oldPath": "DialogMain/Panel_Content/UIButton_Confirm",
        "newPath": "DialogMain/Panel_Other/UIButton_Confirm",
        "oldSiblingIndex": 2,
        "newSiblingIndex": 0,
        "operationType": "move",
  ...
  "results": [
    {
      ...
      "result": {
        "prefabPath": "Assets/ResourcesAB/UIPrefabs/DialogMain.prefab",
        "sourcePath": "DialogMain/Panel_Content/UIButton_Confirm",
        "originalPath": "DialogMain/Panel_Content/UIButton_Confirm",
        "copiedPath": "DialogMain/Panel_Other/UIButton_Confirm",
...
```json
{
  "params": {
    ...
    "targetParentPath": "DialogMain/Panel_Content/UIButton_Confirm"
  }
}
```
...
- 假设 `Panel_Content` 下有 `UIButton_Confirm` (siblingIndex=2)
- 预期:
- 复制一个新的 `UIButton_Confirm` 到 `Panel_Other` 下(索引 0)
- 原来的 `UIButton_Confirm` 保持在 `Panel_Content` 下不变
...
```json
{
  ...
  "commands": [
    ...
    },
    {
      ...
      "params": {
        "prefabPath": "Assets/ResourcesAB/UIPrefabs/DialogMain.prefab",
        "objectPath": "DialogMain/Panel_Content/UIButton_Cancel"
      }
    },
    {
      "id": "cmd_delete_3",
      ...
      "params": {
        "prefabPath": "Assets/ResourcesAB/UIPrefabs/DialogMain.prefab",
        "objectPath": "DialogMain/Panel_Other/UILabel_Title"
      }
    }
  ]
}
...
```json
{
  ...
  "commands": [
    ...
    },
    {
      ...
      "params": {
        "prefabPath": "Assets/ResourcesAB/UIPrefabs/DialogMain.prefab",
        "sourcePath": "DialogMain/Panel_Content/UIButton_Cancel",
        "targetParentPath": "DialogMain/Panel_Other",
...
- 移动后, `Panel_Other` 下的子物体顺序为: `UIButton_Confirm`(索引 0), `UIButton_Cancel`(索引 1)
...
- 预期:
- 复制两个 `UIButton_Confirm` 到 `Panel_Other` 下
- 原来的 `UIButton_Confirm` 保持在 `Panel_Content` 下不变
- `Panel_Other` 下现在有两个复制出的 `UIButton_Confirm`
...
- 假设 `Panel_Content` 下有两个 `UIButton_Confirm` (siblingIndex 分别为 0 和 1)
- 预期:
- 移动第二个 `UIButton_Confirm` (sourceSiblingIndex=1)
- 第一个 `UIButton_Confirm` 保持不变
...
```
Assets/Editor/UnityAgentSkills/Plugins/Prefab/
...
```json
{
  "commands": [
    ...
    },
    {
      ...
      "type": "prefab.deleteGameObject",
      "params": {
        "objectPath": "DialogMain/Panel_Content/UIButton_Confirm" // 错误！父节点已被删除
      }
    }
  ]
}
...
GameObject targetParentGO = GameObjectPathFinder.FindByPath(prefabRoot, targetParentPath, 0);
...
- 正确做法: 先删除 `Panel_Content/UIButton_Confirm`, 再删除 `Panel_Content`
  - 错误做法: 先删除 `Panel_Content`, 再删除其子节点(会失败)
