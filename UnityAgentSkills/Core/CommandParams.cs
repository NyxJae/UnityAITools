...
namespace UnityAgentSkills.Core
{
    ...
    internal sealed class CommandParams
    {
        ...
        public int GetInt(string key)
        {
            if (!Has(key))
            {
                throw new ArgumentException(UnityAgentSkillCommandErrorCodes.InvalidFields + ": Missing int param: " + key);
            }
            ...
            throw new ArgumentException(UnityAgentSkillCommandErrorCodes.InvalidFields + ": Invalid int param: " + key);
        }
