...
using UnityAgentSkills.Plugins.K3Prefab.Handlers;

namespace UnityAgentSkills.Plugins.K3Prefab
{
    /// <summary>
    /// K3预制体命令插件.
    ...
    public class K3PrefabPlugin : ICommandPlugin
    {
        ...
        public void RegisterHandlers(CommandHandlerRegistry registry)
        {
            ...
            registry.Register("k3prefab.createComponent", K3PrefabCreateComponentHandler.Execute);
        }
