...
namespace UnityAgentSkills.Utils.Serialization
{
    ...
    internal static class SerializedFieldFilter
    {
        ...
        /// <summary>
        /// 判断字段是否显式标记 SerializeField.
        /// </summary>
        /// <param name="field">目标字段.</param>
        /// <returns>是否带有 SerializeField.</returns>
        public static bool IsSerializeField(FieldInfo field)
        {
            return field != null && Attribute.IsDefined(field, typeof(SerializeField), inherit: false);
        }
    }
}
